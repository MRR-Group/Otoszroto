...
class SellerControllerTest extends TestCase
{
    ...
    public function testItRendersSellerPageWithOnlyAuthenticatedUsersAuctions(): void
    {
    ...
    public function testItFiltersByCategory(): void
    {
    ...
    public function testItFiltersByBrand(): void
    {
        $user = User::query()->create([
            "firstname" => "Jan",
            "surname" => "Kowalski",
    ...
    public function testItFiltersByModel(): void
    {
        $user = User::query()->create([
            "firstname" => "Jan",
            "surname" => "Kowalski",
    ...
    public function testItFiltersByConditionStatusAndPriceRange(): void
    {
        $user = User::query()->create([
            "firstname" => "Jan",
            "surname" => "Kowalski",
