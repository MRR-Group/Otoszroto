                ...
                <div className="mx-auto max-w-7xl p-6 lg:p-8">
                    ...
                    <div className="mt-16">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div>
                                    <div className="flex size-16 items-center justify-center rounded-full bg-red-50 dark:bg-red-800/20">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth={1.5}
                                            className="size-7 stroke-red-500"
                                        >
                                            <path
                                                strokeLinecap="round"
                                ...
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    strokeWidth={1.5}
                                    className="mx-6 size-6 shrink-0 self-center stroke-red-500"
                                >
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                >
                                    <svg
                                        ...
                                        viewBox="0 0 24 24"
                                        strokeWidth={1.5}
                                        className="-mt-px mr-1 size-5 stroke-gray-400 group-hover:stroke-gray-600 dark:stroke-gray-600 dark:group-hover:stroke-gray-400"
                                    >
                                        <path
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
